...
const SHEETS = {
  player: `${import.meta.env.BASE_URL}sprites/player.png`,
  drone: `${import.meta.env.BASE_URL}sprites/enemy-drone.png`,
  fighter: `${import.meta.env.BASE_URL}sprites/enemy-fighter.png`,
  pbolt: `${import.meta.env.BASE_URL}sprites/player-bolt.png`,
  ebolt: `${import.meta.env.BASE_URL}sprites/enemy-bolt.png`,
  muzzle: `${import.meta.env.BASE_URL}sprites/muzzle.png`,
  explode: `${import.meta.env.BASE_URL}sprites/explode.png`,
  multi: `${import.meta.env.BASE_URL}sprites/pu-multi.png`,
  shield: `${import.meta.env.BASE_URL}sprites/pu-shield.png`,
  speed: `${import.meta.env.BASE_URL}sprites/pu-speed.png`,
  life: `${import.meta.env.BASE_URL}sprites/pu-life.png`,
} as const;
